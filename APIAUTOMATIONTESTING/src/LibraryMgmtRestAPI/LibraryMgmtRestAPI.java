...
public class LibraryMgmtRestAPI {

		@Test
		public void RestApi() throws XmlException, IOException, SoapUIException {
			WsdlProject wsd = new WsdlProject("C:\\Users\\cyb3r_ark97.cyb3r_ark97\\Downloads\\LibraryRestAPI.xml");
			WsdlTestSuite testsuite = wsd.getTestSuiteByName("LibraryRestAPI TestSuite");
